...
**Regra:** os comandos abaixo correspondem à release **`1.9.75`**. Em cada
...
| Canal | Versão | Papel |
|-------|--------|--------|
| **`latest` / updater GUI** | **`1.9.75`** | Único pacote público para download |
...
```sh
fetch -o /tmp/pfSense-pkg-layer7-1.9.75.pkg \
  https://github.com/pablomichelin/Layer7/releases/download/v1.9.75/pfSense-pkg-layer7-1.9.75.pkg
```

```sh
fetch -o /tmp/pfSense-pkg-layer7-1.9.75.pkg.sha256 \
  https://github.com/pablomichelin/Layer7/releases/download/v1.9.75/pfSense-pkg-layer7-1.9.75.pkg.sha256 \
  && sha256 -q /tmp/pfSense-pkg-layer7-1.9.75.pkg | tee /tmp/l7-actual.sha256 \
  && cat /tmp/pfSense-pkg-layer7-1.9.75.pkg.sha256
```
