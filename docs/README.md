...
| Fecho producao + consolidacao | [`02-roadmap/plano-fecho-producao-e-consolidacao.md`](02-roadmap/plano-fecho-producao-e-consolidacao.md) | plano mestre inicio/meio/fim (software + docs + versionamento) |
| Arranque chat desse plano | [`00-overview/START-HERE-fecho-producao.md`](00-overview/START-HERE-fecho-producao.md) | prompt para colar; regras multitarefa / file ownership |
...
|------|--------------------------|--------|
| Overview e navegacao | [`00-overview/product-charter.md`](00-overview/product-charter.md), [`00-overview/document-classification.md`](00-overview/document-classification.md), [`00-overview/document-equivalence-map.md`](00-overview/document-equivalence-map.md), [`00-overview/handoff-chat-novo.md`](00-overview/handoff-chat-novo.md) (mudar de chat quando o contexto fica longo; verificacao opcional pos-clone, ponto 6, e politica de smoke por OS), [`00-overview/START-HERE-fecho-producao.md`](00-overview/START-HERE-fecho-producao.md) (arranque do plano de fecho/consolidacao), [`00-overview/f3-11-start-here.md`](00-overview/f3-11-start-here.md), [`00-overview/f3-organizacao-local-e-fecho.md`](00-overview/f3-organizacao-local-e-fecho.md), [`00-overview/f3-11-document-traceability-map.md`](00-overview/f3-11-document-traceability-map.md) | canónico |
...
| Roadmap e execucao | [`02-roadmap/roadmap.md`](02-roadmap/roadmap.md), [`02-roadmap/backlog.md`](02-roadmap/backlog.md), [`02-roadmap/checklist-mestre.md`](02-roadmap/checklist-mestre.md), [`02-roadmap/plano-fecho-producao-e-consolidacao.md`](02-roadmap/plano-fecho-producao-e-consolidacao.md), [`02-roadmap/f1-plano-de-implementacao.md`](02-roadmap/f1-plano-de-implementacao.md), [`02-roadmap/f2-plano-de-implementacao.md`](02-roadmap/f2-plano-de-implementacao.md), [`02-roadmap/f4-plano-de-implementacao.md`](02-roadmap/f4-plano-de-implementacao.md), [`02-roadmap/f5-preparacao-malha.md`](02-roadmap/f5-preparacao-malha.md) | canónico |
...
| Releases | [`06-releases/README.md`](06-releases/README.md), [`06-releases/RELEASE-SIGNING.md`](06-releases/RELEASE-SIGNING.md), rascunho pre-publicacao [`06-releases/release-notes-1.8.11_10-DRAFT.md`](06-releases/release-notes-1.8.11_10-DRAFT.md) (conteudo alinhado ao port no branch, ex. `1.8.11_12`; ver [`CORTEX.md`](../CORTEX.md); classificacao) | canónico; DRAFT e suplementar ate tag |
