...
| [ADR-0026](ADR-0026-mitm-tls-inspection-opt-in.md) | MITM TLS inspection opt-in (CA/certificado) | **Aceito — runtime shipped** (rev.p; `1.9.46`) | Teste PASS; P1+P2 docs; activar piloto NO-GO até P3+ficha; ficha=gate activação ≠ gap eng.; Squid rejeitado |
