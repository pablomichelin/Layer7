...
| [ADR-0037](ADR-0037-frontend-nativo-pfsense.md) | Frontend Layer7 nativo ao pfSense | **Aceito** (`2026-08-31`) | BG-174; shell/tabs/componentes pfSense; formulários planos com barras de secção e linhas nativas; sem cards ou frontend paralelo |
