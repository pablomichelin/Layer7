...
| [ADR-0037](ADR-0037-frontend-nativo-pfsense.md) | Frontend Layer7 nativo ao pfSense | **Aceito** (`2026-08-31`) | BG-174; frontend-only; lógica congelada; consumir `head.inc`/`foot.inc`/`Form_*`; zero CSS visual próprio por defeito; sem cards ou frontend paralelo |
