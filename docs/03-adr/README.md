...
| [ADR-0026](ADR-0026-mitm-tls-inspection-opt-in.md) | MITM TLS inspection opt-in (CA/certificado) | **Aceito — runtime shipped** (rev.n; `1.9.46`) | GI2/GI3 PASS lab; teste controlado PASS; piloto/permanente NO-GO até mapa+GO; Squid rejeitado |
