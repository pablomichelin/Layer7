...
| [ADR-0024](ADR-0024-suporte-ipv6-ativacao-faseada.md) | Suporte IPv6 — ativação faseada (trilha V0–V6) | Aceito | Arranque único `START-HERE-fecho-producao.md`; V0/GV0 PASS; passo **12.3** (V1) |
