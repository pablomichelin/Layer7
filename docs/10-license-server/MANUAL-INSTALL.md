...
disponivel para download. O updater GUI aponta para `latest` (`1.9.75`).
...
> deve devolver **apenas** URLs de `v1.9.75` (canal unico).
> **Estado actual:** canal publico/`latest` = **`1.9.75`** (BG-168).
> Pin enforce `1.9.8` e referencia de politica, **sem** download publico.

> **Release `1.9.75` (BG-168, `2026-08-26`):** unico pacote no canal
> publico. Rollback publico = reinstalar `1.9.75` (latest-only; `1.9.74`
> fica so na tag git / builder). Pin enforce `1.9.8` permanece politica
> interna; artefactos antigos so no builder/arquivo.

**Versao canal publico / lab (`latest` e comandos abaixo):** `1.9.75`

- **Release:** `https://github.com/pablomichelin/Layer7/releases/tag/v1.9.75`
- **Pacote `.pkg`:** `https://github.com/pablomichelin/Layer7/releases/download/v1.9.75/pfSense-pkg-layer7-1.9.75.pkg`
- **SHA256:** `https://github.com/pablomichelin/Layer7/releases/download/v1.9.75/pfSense-pkg-layer7-1.9.75.pkg.sha256`
- **SHA256 esperado:** `90e5bb2e6369ca2c5b2ce5afc926cacd2ea0fdd2426b13d400901b1de3c72e75`
...
(`1.9.75`). Pacotes anteriores **nao** tem URL de download. Tags git e
SHAs abaixo ficam como arquivo interno. Rollback de emergencia = reinstalar
`1.9.75` ou rebuild da tag git `v1.9.74` no builder. Pin enforce `1.9.8`
...
| Versao | SHA256 | Nota |
|--------|--------|------|
| `1.9.75` | `90e5bb2e6369ca2c5b2ce5afc926cacd2ea0fdd2426b13d400901b1de3c72e75` | canal publico actual |
...
Baixar o `.pkg` directo da versao `1.9.75`:
...
`90e5bb2e6369ca2c5b2ce5afc926cacd2ea0fdd2426b13d400901b1de3c72e75`.
...
> **Nesta release (`1.9.75`)** o caminho oficial e o **`install.sh`**
> carimbado F1.2 (fail-closed). O comando unico manual permanece como
> alternativa. **Canal lab/`latest`:** **`1.9.75`**. **Producao enforce:**
...
> **Nesta release (`1.9.75`)** o `uninstall.sh` automatico **e publicado**
...
```sh
fetch -o /tmp/uninstall.sh https://github.com/pablomichelin/Layer7/releases/download/v1.9.75/uninstall.sh
```
...
Para reinstalar a versao actual (`1.9.75`), usar o **`install.sh`** da
...
Rollback publico = reinstalar **`1.9.75`** (seccoes 1 / 5). Tag git
