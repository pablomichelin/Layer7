...
Para uma versao especifica: `sh /tmp/install.sh --version 1.3.3`
...
```sh
fetch -o /tmp/pfSense-pkg-layer7-1.3.3.pkg https://github.com/pablomichelin/pfsense-layer7/releases/download/v1.3.3/pfSense-pkg-layer7-1.3.3.pkg && IGNORE_OSVERSION=yes pkg add -f /tmp/pfSense-pkg-layer7-1.3.3.pkg && sysrc layer7d_enable=YES && service layer7d onestart && layer7d -V
```

**Passo a passo (SSH/Console):**

```sh
fetch -o /tmp/pfSense-pkg-layer7-1.3.3.pkg https://github.com/pablomichelin/pfsense-layer7/releases/download/v1.3.3/pfSense-pkg-layer7-1.3.3.pkg
```
```sh
...
```
```sh
IGNORE_OSVERSION=yes pkg add -f /tmp/pfSense-pkg-layer7-1.3.3.pkg
```
...
```sh
service layer7d onestop && fetch -o /tmp/pfSense-pkg-layer7-1.3.3.pkg https://github.com/pablomichelin/pfsense-layer7/releases/download/v1.3.3/pfSense-pkg-layer7-1.3.3.pkg && IGNORE_OSVERSION=yes pkg add -f /tmp/pfSense-pkg-layer7-1.3.3.pkg && service layer7d onestart && layer7d -V
```
...
```sh
service layer7d onestop && pkg delete -y pfSense-pkg-layer7 && IGNORE_OSVERSION=yes pkg add -f /tmp/pfSense-pkg-layer7-1.3.3.pkg && sysrc layer7d_enable=YES && service layer7d onestart
```
