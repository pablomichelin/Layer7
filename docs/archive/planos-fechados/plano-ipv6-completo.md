...
> ## 【ARQUIVO · PLANO FECHADO】 — não reabrir sem GO
>
> Fila **fechada**. Veredicto vivo: [`ESTADO-PRODUTO-E-PLANOS-FECHADOS.md`](../../00-overview/ESTADO-PRODUTO-E-PLANOS-FECHADOS.md)
> Arranque de chat: [`START-HERE-fecho-producao.md`](../../00-overview/START-HERE-fecho-producao.md)
...
| IPv6 completo | **V0–V6** | **FECHADA** — GV7.4 PASS; produção enforce **`1.9.8`** |
...
Em 12.6–12.8 (daemon) a GUI podia ainda rejeitar IPv6. Testes de política v6
no lab usavam **config JSON manual** / appliance até **12.9** — documentar no
`run_id` se a evidência for anterior a 12.9.
...
- Impasse V5 (NAT64/NPT) sem decisão humana → parar em V5 com I7 em ADR
