...
**Regra de evidência:** tarefas que exigem pfSense/FreeBSD só podem ser marcadas `[x]` após execução no ambiente correto e registo em [`docs/04-package/validacao-lab.md`](../04-package/validacao-lab.md) (ou anexo).
...
### Saída
Artefactos em `package/pfSense-pkg-layer7/`. Validação: [`docs/04-package/validacao-lab.md`](../04-package/validacao-lab.md).
