...
> ## 【ARQUIVO · LEGADO】 — não é SSOT
>
> Conteúdo histórico movido na **F6 H5** (`2026-08-05`).
> Fonte operacional: [`CORTEX.md`](../../../CORTEX.md) · índice: [`docs/README.md`](../../README.md)
> Equivalência: [`document-equivalence-map.md`](../../00-overview/document-equivalence-map.md)
> Índice deste arquivo: [`README.md`](README.md)
...
> preservado** — consultar [`docs/00-overview/document-equivalence-map.md`](../00-overview/document-equivalence-map.md)
...
| **Congelamento** | [`ESTADO-PRODUTO-E-PLANOS-FECHADOS.md`](../00-overview/ESTADO-PRODUTO-E-PLANOS-FECHADOS.md) |
| **Arranque chat** | [`START-HERE-fecho-producao.md`](../00-overview/START-HERE-fecho-producao.md) |

> **Versão actual (`latest` = enforce):** `1.9.8`. Filas fecho+IPv6 **fechadas**. Novos planos: ESTADO-PRODUTO §6.

Instalacao, upgrade e rollback: [`docs/10-license-server/MANUAL-INSTALL.md`](../10-license-server/MANUAL-INSTALL.md).
...
3. [`docs/README.md`](../README.md) — indice documental canónico
4. [`docs/02-roadmap/backlog.md`](../02-roadmap/backlog.md) — prioridades
5. [`docs/02-roadmap/checklist-mestre.md`](../02-roadmap/checklist-mestre.md) — gates
6. Area em causa (ex.: enforcement → [`docs/09-blocking/plano-enforcement-100-porcento.md`](../09-blocking/plano-enforcement-100-porcento.md))

**Handoff chat longo:** [`docs/00-overview/handoff-chat-novo.md`](../00-overview/handoff-chat-novo.md)

**Arranque único (pós-fecho):**
[`docs/00-overview/START-HERE-fecho-producao.md`](../00-overview/START-HERE-fecho-producao.md)
→ consolidação: [`docs/00-overview/ESTADO-PRODUTO-E-PLANOS-FECHADOS.md`](../00-overview/ESTADO-PRODUTO-E-PLANOS-FECHADOS.md)
→ histórico IPv6: [`docs/02-roadmap/plano-ipv6-completo.md`](../02-roadmap/plano-ipv6-completo.md)
...
Plano SSOT: [`docs/09-blocking/plano-enforcement-100-porcento.md`](../09-blocking/plano-enforcement-100-porcento.md).
...
- Rollback enforce (`1.9.0`):
  ...
  ```
- Build: builder FreeBSD `192.168.100.12` — ver [`docs/08-lab/builder-freebsd.md`](../08-lab/builder-freebsd.md)
...
Para historico de fases 0–11 e motor multi-interface v0.2.0, ver [`docs/changelog/CHANGELOG.md`](../changelog/CHANGELOG.md)
