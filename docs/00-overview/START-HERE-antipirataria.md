...
> Worktree sujo `30.11` **preservar**. **BG-128** aberto; **P0-2 e P1-1 FEITOS**
> no git (`2026-08-14`; sem deploy). Próximo código com GO = **P1-2**.
...
2. **Não** reabrir AP0–AP4. O GO `2026-08-14` autoriza evidência de campo.
   **P0-2 e P1-1 FEITOS** no git. Código seguinte com GO = **P1-2** (BG-128),
   sem `.244` e sem commit 30.11.
...
| Próxima acção código | **P1-2** (BG-128). **P0-2 e P1-1 FEITOS** no git (sem deploy) |
...
- Auditoria 2026-08-14: P0-1 ACTIVO; BG-128 ABERTO; P0-2 e P1-1 FEITOS no git; próximo código com GO = P1-2
