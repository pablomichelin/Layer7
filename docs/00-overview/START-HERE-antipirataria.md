# START HERE — Anti-pirataria e Anti-tamper 【`30.4` FECHADO · próximo `30.5` · **Composer 2.5**】

> **Diagnóstico ACEITE** `2026-08-10` — [`modelo-ameacas-antipirataria.md`](../01-architecture/modelo-ameacas-antipirataria.md).
> **`30.4` FECHADO** — `is_dev_key` só sob `L7_DEV_BUILD`; GA2.1–2.3 **PASS**; BG-114 **Concluido**.
> **Passo actual a executar: `30.5`** — strip / endurecimento de build (BG-115).
...
> **Evidência 30.4:** [`../tests/evidence/20260810T235325Z-30.4-no-dev-bypass/`](../tests/evidence/20260810T235325Z-30.4-no-dev-bypass/)
> **Canal lab/`latest`:** `1.9.49` (publicado). Rollback lab: `1.9.48`.
...
1. Colar **apenas** o caminho acima **ou** o *Prompt — 30.5* abaixo.
...
| [`plano-gates-antipirataria.md`](../09-blocking/plano-gates-antipirataria.md) | Gates — **GA0/GA1 PASS**; GA2.1–2.3 PASS |
...
| Passo actual | **`30.4` FECHADO** — próximo a executar: **`30.5`** |
| Decisão 4 (pubkey) | **Fora do git (builder)** — SoT aplicada; **inalterada** em 30.4 |
| Gate activo | **GA2 parcial** — GA2.1–2.3 PASS; GA2.4+ com `30.5`/`30.7` |
| Código de produto | **`30.4` aplicado** (`license.c` + Makefiles); BG-114 Concluido |
| Agente | **Composer 2.5** — um passo por chat (plano §8) |
| Canal lab/`latest` | **`1.9.49`** — rollback lab **`1.9.48`** |
...
5. [`plano-antipirataria-anti-tamper.md`](../02-roadmap/plano-antipirataria-anti-tamper.md) — §0, §0.0, §0.1 RR, §1 N1–N8, **§8 Composer**, passo actual (`30.5`)
6. [`plano-gates-antipirataria.md`](../09-blocking/plano-gates-antipirataria.md) — GA2.4 / GA2.5 / GA2.11
7. [`builder-freebsd.md`](../08-lab/builder-freebsd.md)
8. Evidência `30.4`: [`../tests/evidence/20260810T235325Z-30.4-no-dev-bypass/`](../tests/evidence/20260810T235325Z-30.4-no-dev-bypass/)

Baseline: [`ESTADO-PRODUTO-E-PLANOS-FECHADOS.md`](ESTADO-PRODUTO-E-PLANOS-FECHADOS.md)

---

## Prompt — Composer 2.5 (passo `30.5`)

```text
Modelo: Composer 2.5.
Contexto: trilha Anti-pirataria / Anti-tamper; baseline enforce 1.9.8; lab/latest 1.9.48 (.pkg);
lab/latest 1.9.49 (.pkg).
...
Gates: docs/09-blocking/plano-gates-antipirataria.md (GA2.4 / GA2.5 / GA2.11)
Ler na ordem do START-HERE; cumprir plano §8.
Estado: 30.4 FECHADO + 1.9.49 publicado; GA2.1–2.3 PASS; executar SOMENTE 30.5.
AGORA: 30.5 — strip no INSTALL_PROGRAM do port (BG-115); avaliar -fvisibility=hidden
se seguro; SEM ofuscação; nm/strings sem is_dev_key/layer7_license_check;
smoke -t/--fingerprint; registar limite de diagnóstico; NÃO iniciar 30.6
neste chat salvo pedido explícito.
...
| AP1 | GA2 | **PARCIAL** — GA2.1–2.3 PASS (`30.4`); falta `30.5`/`30.7` |
| AP1 | GA3 | PENDENTE |
| AP2 | GA4 | PENDENTE |
| AP3 | GA5 | PENDENTE |
| AP4 | GA6 | PENDENTE |
...
- Onda: AP1 em curso
- Passo: 30.4 FECHADO; PRÓXIMO EXECUTAR = 30.5
