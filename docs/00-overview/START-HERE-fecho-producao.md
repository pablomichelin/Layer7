...
| **IPv6 completo V0–V6** | **ABERTA** — passo **12.8** (V3) | [`plano-ipv6-completo.md`](../02-roadmap/plano-ipv6-completo.md) |
...
| **Passo autorizado** | **12.8** (Onda V3 — allowlist IPv6 host/CIDR) |
| **BG activo** | BG-081 (V3; 12.7 enforce PF v6 concluído) |
...
| Passo **12.8** (autorizado) | Allowlist IPv6 host/CIDR — **V3** |
...
Regras absolutas:
- Executar SOMENTE o passo 12.x autorizado no CORTEX (agora: 12.8).
