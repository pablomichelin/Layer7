...
| **IPv6 completo V0–V6** | **ABERTA** — passo **12.6** (V3) | [`plano-ipv6-completo.md`](../02-roadmap/plano-ipv6-completo.md) |
...
| Passo **12.6** (autorizado) | `policy.c` CIDR IPv6 — **V3** |
...
Regras absolutas:
- Executar SOMENTE o passo 12.x autorizado no CORTEX (agora: 12.6).
...
| **12.6** | V3 | `policy.c` CIDR IPv6 — **actual** |
| 12.7–12.8 | V3 | Enforce / allowlist v6 |
