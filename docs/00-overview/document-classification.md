...
| `docs/09-blocking/auditoria-licencas-auth-deploy-2026-08-14.md` | auditoria licenças/auth/deploy | **SSOT** achados P0–P3 + bloqueio P0-1 contra deploy integral HEAD | Canónico | complementar a BG-128 e ao runbook de freeze | manter até remediações; não tratar compose HEAD como live | manutenção |
| `docs/13-runbooks/bloqueio-deploy-integral-head-30.11.md` | freeze deploy HEAD↔30.11 | runbook operativo **P0-1 ACTIVO** | Canónico | complementar à auditoria e à publicação segura | vivo até 30.11 versionado + GO | manutenção |
