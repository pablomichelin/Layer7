...
| `docs/03-adr/ADR-0036-install-ping-sem-serial.md` | sinal instalação sem serial | **Aceito** (`2026-08-22`) | Canónico | BG-162 live; BG-163 cliente | publish `1.9.72` pendente | manutenção |
