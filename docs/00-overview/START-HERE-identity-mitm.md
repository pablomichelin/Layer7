...
| Passo actual | **IM6 / 20.23** — políticas `ad_users`/`ad_groups` (20.22 conflito **PASS**) |
...
Tarefa: continuar no passo actual (IM6 / 20.23 — políticas ad_users/ad_groups; 20.22 PASS).
```
...
- Passo actual: IM6 / 20.23 (políticas ad_users/ad_groups)
