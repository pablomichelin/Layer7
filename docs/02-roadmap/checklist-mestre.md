...
- [ ] **BG-171** — implementado, pendente de gates/commit — Pornografia `match_mode=or` (host OU AdultContent)
- [ ] **BG-172** — implementado, pendente de gates/commit — Eventos em linguagem de operador (cartões + detalhe técnico opt-in)
