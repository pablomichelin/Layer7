...
- [x] **BG-165** — implementado no git (`1.9.73`; pendente gates/publish) — curl absoluto + flock; badge `.lic`; disarm; ping sem fallback de ID
- [x] **BG-166** — implementado no git privado (live `.244` pendente GO) — UPSERT COALESCE; `normalizeFeatures`; `getClientIp` em activate/check-in
