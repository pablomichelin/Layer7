...
GA3 PASS. BG-120 **Concluido**. Token: `30.8`–`30.10` código/release OK (`1.9.53`);
**30.9 live PASS**; **campo BLOCKED** (`fetch_authed` HTTP 302). BG-117: falta fix
fetch autenticado + e2e + `30.11`. **Próximo:** fix `fetch_authed` + revalidação `.254` — **não** `30.11`.
