...
- Plano: [`plano-identity-mitm-addon.md`](plano-identity-mitm-addon.md) rev. `2026-08-09au`
- Passo actual: **`1.9.47`** P3 PASS; **P4 CLOSED FAIL/ABORT** (`234042Z`); Identity rede **FECHADA** (20.33/GI9)
- Prontidão piloto: **NÃO PRONTO activar externo** — P1+P2+P3 PASS; P4 FAIL/ABORT; **P5 aguarda ficha**; [`mapa`](../09-blocking/mapa-prontidao-mitm-piloto-2026-08-09.md)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.11 + D0/D1 + Gate C + GO teste + P3 | Alta | package/GUI | Identity+MITM | Piloto sem ficha/soak | M | Alto | **P3 PASS** `1.9.47`; **P4 CLOSED FAIL/ABORT** `234042Z`; activar externo **NO-GO** até ficha+P5 | supervisor nao armado; rollback limpo; sem piloto externo |
...
**`30.12`–`30.18` FECHADOS** (AP3 + AP4/`30.16`–`30.18`; GA5.1–5.8 + 5.10–5.12
PASS; GA6.1–6.6 PASS com 6.5 processo + residual campo; BG-118/119/121/122/123/101
**Concluido**). Candidato `1.9.58` sem release. **Próximo:** AP4 `30.19` —
só com pedido; não misturar com MITM/IPv6.
