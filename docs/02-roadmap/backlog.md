...
GA3 PASS. BG-120 **Concluido**. Token: `30.8`–`30.10` + fix fetch `1.9.54`;
**30.9 live PASS**; **e2e `.254` pendente**. BG-117: falta e2e + `30.11`.
**Próximo:** validação `.254` com `1.9.54` — **não** `30.11`.
