...
| BG-011 | Validar forcing DNS e anti-bypass em cenarios reais de VLAN/interface, excepcoes e tabelas PF | Alta | daemon/enforcement | F4 | bypass continuar a aparecer em combinacoes menos comuns | M | Alto | Em curso (F4.3) | primeiro bloco 2026-04-24: `rdr`/dedupe/validacao CIDR e guards em `layer7_get_pfsense_interfaces`; matriz de lab ainda aberta |
