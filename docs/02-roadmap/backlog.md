...
| BG-009 | Consolidar confiabilidade de package/daemon em reboot, reload, upgrade, rollback e reinicio de servico | Alta | package/daemon | F4 | runtime continuar a divergir entre estado desejado e estado real | G | Alto | Em curso (F4.1) | aberto em F4.0 (2026-04-24); `layer7-stats-collect.sh` (pidfile) e `rc.d/layer7d` (`layer7d_pid_from_file`); `PORTREVISION` 5; evidencias em appliance; ver `f4-plano-de-implementacao.md` |
