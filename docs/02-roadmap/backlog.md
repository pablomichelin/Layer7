...
- Passo actual: **20.6 / IM1** (GI1); **20.3–20.5 PASS**
...
| BG-086 | Entitlements `features` CSV + gates daemon/GUI/license-server (IM1) | Critica | licenciamento | IM1 | add-on sem enforcement comercial | G | Alto | **Em curso (20.5 PASS; 20.6 actual)** | falta check-in ∩ .lic + GI1 |
