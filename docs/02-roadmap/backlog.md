...
| BG-046 | Caminho B / E1 — decisao unificada DNS/nDPI/SNI | Alta | daemon | Caminho B (E1) | DNS atalho ignora origem; decisoes inconsistentes entre caminhos | M | Alto | Concluido | `layer7_decide_for_client()`; `test_policy_decide.c`; legacy mantem `layer7_domain_is_blocked` |
...
| BG-049 | Caminho B / E4 — semantica AND/OR + validacao GUI | Alta | daemon/gui | Caminho B (E4) | app+host OR alarga bloqueio; match vazio catch-all | M | Alto | Planeado | match_mode; scope_global; alinhar policy-matrix |
| BG-050 | Caminho B / E5 — hibrido app=origem site=destino | Alta | daemon/package | Caminho B (E5) | apps e sites misturados no mesmo enforcement global | M | Alto | Planeado | enforce_kind automatico |
...
| BG-052 | Caminho B / E7/E8 — testes two-client + release default scoped | Alta | testes/release | Caminho B (E7/E8) | sem rede de seguranca scoped; default legacy permanente | G | Alto | Planeado | smoke-enforcement-scoped.sh; default scoped_hybrid em E8 |
