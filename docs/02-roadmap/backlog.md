...
| BG-088 | Identity map **daemon** + LDAP/LDAPS (IM3–IM4) — **caminho de valor PME** | Critica | daemon/GUI | IM3–IM4 | user/grupo sem mapa dinâmico | G | Alto | Em curso / **passo 20.18** | 20.17 LDAP client PASS; Test GUI a seguir |
