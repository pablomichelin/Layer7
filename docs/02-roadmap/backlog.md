...
| BG-009 | Consolidar confiabilidade de package/daemon em reboot, reload, upgrade, rollback e reinicio de servico | Alta | package/daemon | F4 | runtime continuar a divergir entre estado desejado e estado real | G | Alto | Em curso (F4.1) | aberto em F4.0 (2026-04-24); `layer7-stats-collect.sh` com leitura de pidfile alinhada ao updater; `PORTREVISION` 4; evidencias em appliance; ver `f4-plano-de-implementacao.md` |
