...
| BG-070 | Perfis rapidos editaveis e personalizados (overlay profiles-custom.json) | Alta | package/GUI | Caminho A / UX F4.3 | upgrades sobrescrevem profiles.json; cliente nao pode ajustar catalogo | G | Medio | Concluido codigo (`1.8.11_55`); gate appliance pendente | overlay fora pkg-plist; merge layer7_load_profiles; GUI editar/criar/apagar; export/import; auto-reconnect politica; producao enforce continua `_24` |
