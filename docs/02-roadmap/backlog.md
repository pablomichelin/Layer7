...
| BG-158 | Corrigir integridade de tradução PT/EN/ES | Alta | package/GUI | manutenção / F4.3 | fallback ES para EN e chaves históricas EN no PT causam interface mista | P | Médio | **Implementado — pendente de gates/release** (`1.9.67`, `2026-08-15`) | Catálogo ES sem fallback EN, catálogo PT para chaves históricas EN, textos dinâmicos de Eventos localizados e gate PT/EN/ES reforçado. Sem daemon, licença ou deploy `.244`. |
