...
- Passo actual: **20.11 PASS** (`1.9.41` GI2/GI3); próximo fecho IM2 / GO produção MITM; Identity rede **FECHADA** (20.33/GI9)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.11 | Alta | package/GUI | Identity+MITM | GO produção MITM humano | M | Alto | **20.11 PASS (`1.9.41`)** | GI2/GI3 lab `.54`; sem intercept prod |
