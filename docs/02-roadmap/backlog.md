...
| BG-148 | P3-8: recheck read-only do cut `30.11` (`asset_count=0` + 404 anónimo) | Baixa | docs/distribuição | manutenção / pós-auditoria (BG-128) | último recheck 12-08; PoPs/TTL não observados na auditoria de 14-08 | P | Baixo | **Concluido** (`2026-08-14`; sem deploy / `PORTVERSION`) | Confirmação BG-148 `20260814T201800Z`: id `313502667`; `prerelease=true`; `draft=false`; `assets=[]`; `asset_count=0`; 404×4; primary 401. Evidência `20260814T200900Z-p38-cut-recheck`. Sem mudança de runtime. Residual P3-9 (URLs não removidos). |
