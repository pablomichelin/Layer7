...
- Passo actual: **`1.9.47`** P3 PASS; **P4 ABORT** (`234042Z`); Identity rede **FECHADA** (20.33/GI9)
- Prontidão piloto: **NÃO PRONTO activar** — P1+P2+P3 PASS; P4 ABORT; **P5 aguarda ficha**; [`mapa`](../09-blocking/mapa-prontidao-mitm-piloto-2026-08-09.md)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.11 + D0/D1 + Gate C + GO teste + P3 | Alta | package/GUI | Identity+MITM | Piloto sem ficha/soak | M | Alto | **P3 PASS** `1.9.47`; **P4 ABORT** `234042Z`; activar **NO-GO** até ficha+P5 | P4 rollback OK; P5 aguarda ficha; sem piloto externo |
