...
| BG-090 | Políticas `ad_users`/`ad_groups` → identity_ips (IM6) | Alta | package/daemon | IM6 | directório sem enforcement útil | G | Alto | Em curso (20.23 PASS; 20.24 match) | GI7; não-regressão IP/MAC |
