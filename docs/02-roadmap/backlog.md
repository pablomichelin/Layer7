...
- Passo actual: **20.15 / IM3** (entitlement gate); **20.14 PASS**; **IM1/GI1 PASS**; **IM2 DEFER 20.7a**
...
| BG-088 | Identity map **daemon** + LDAP/LDAPS (IM3–IM4) — **caminho de valor PME** | Critica | daemon/GUI | IM3–IM4 | user/grupo sem mapa dinâmico | G | Alto | Em curso / **passo 20.15** | mapa 20.12–20.14 PASS; gate 20.15 |
