...
- Passo actual: **P4 retry** (`1.9.59` publicado); **P4 CLOSED FAIL/ABORT** (`234042Z`); Identity rede **FECHADA** (20.33/GI9)
...
- Baseline produção: **`1.9.8`**. lab/`latest`: **`1.9.59`**. Captive portal: **fora de escopo**. Squid: **rejeitado**.
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.11 + D0/D1 + Gate C + GO teste + P3 + P4.1 | Alta | package/GUI | Identity+MITM | Piloto sem ficha/soak | M | Alto | **P3 PASS** `1.9.47`; **P4 FAIL/ABORT**; **P4.1 publicado** `1.9.59`; activar externo **NO-GO** até ficha+P5 | supervisor on-box; P4 retry; sem piloto externo |
