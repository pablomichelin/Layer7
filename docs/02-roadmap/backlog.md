...
| BG-050 | Caminho B / E5 — hibrido app=origem site=destino | Alta | daemon/package | Caminho B (E5) | apps e sites misturados no mesmo enforcement global | M | Alto | Em execucao (parcial `_25`) | decisão passa a escolher app/categoria=`psrc` e host=`pdst`; gate appliance pendente |
