...
- Passo actual: **20.11 PARCIAL** (`1.9.41` GI2 PASS; GI3 PENDENTE S3); próximo lab S3 browser Windows; Identity rede **FECHADA** (20.33/GI9)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.11 | Alta | package/GUI | Identity+MITM | S3 browser Windows → fechar GI3 | M | Alto | **20.11 PARCIAL** | GI2 PASS; GI3 PENDENTE S3; S6 NA |
