...
- Passo actual: **20.10a** (`1.9.39`); próximo **20.10b**; Identity rede **FECHADA** (20.33/GI9)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.10a | Alta | package/GUI | Identity+MITM | intercept 20.10b | M | Alto | **20.10a em curso (`1.9.39`)** | GO produto; runtime no pkg OFF; próximo 20.10b |
