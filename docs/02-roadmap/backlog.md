...
| BG-169 | Perfil rápido Pornografia (renome + catálogo) | Media | package/GUI | manutenção / F4.3 | atalho adulto tinha 15 hosts e nome pouco visível; cliente pede perfil Pornografia | P | Medio | **Implementado, pendente de gates/commit** (`1.9.76`) | Id `adulto` estável; nome **Pornografia**; 64 hosts + `AdultContent`; preset infantil alargado; i18n EN/ES. Sem segundo id. Cobertura completa = UT1. |
