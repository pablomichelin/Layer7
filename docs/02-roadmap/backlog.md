...
- Passo actual: **20.5 / IM1** (GUI upsell); **20.3–20.4 PASS**
...
| BG-086 | Entitlements `features` CSV + gates daemon/GUI/license-server (IM1) | Critica | licenciamento | IM1 | add-on sem enforcement comercial | G | Alto | **Em curso (20.4 PASS; 20.5 actual)** | daemon+LS; falta GUI upsell + GI1 |
