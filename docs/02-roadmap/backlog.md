...
| BG-006 | Definir modelo de estados do licenciamento: activar, reactivar, renovar, revogar, expirar, grace e offline | Alta | licenciamento | F3 | suporte e troubleshooting continuarem dependentes de tentativa e erro | M | Alto | Em execucao na F3.4 | contrato canónico inicial foi aberto na F3.1, a matriz de fingerprint foi fechada na F3.2, a semantica real de expiracao/revogacao/offline foi fechada na F3.3 e a superficie administrativa com guardrails minimos foi fechada na F3.4; faltam evidencias de appliance/lab |
