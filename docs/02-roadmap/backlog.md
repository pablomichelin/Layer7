...
GA3 PASS. BG-120 **Concluido**. Token: desenho `30.8` + emissão `30.9` **FECHADOS**. BG-117 continua para `30.10`–`30.11`. Próximo: **`30.10`**. Ver plano §8.
