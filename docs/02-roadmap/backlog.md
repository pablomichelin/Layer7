...
- Plano: [`plano-identity-mitm-addon.md`](plano-identity-mitm-addon.md) rev. `2026-08-13ax`
- Passo actual: **P4.1** supervisor on-box (candidato `1.9.59` local); **P4 CLOSED FAIL/ABORT** (`234042Z`); Identity rede **FECHADA** (20.33/GI9)
- Prontidão piloto: **NÃO PRONTO activar externo** — P1+P2+P3 PASS; P4 FAIL/ABORT; P4.1 local; **P5 aguarda ficha**; [`mapa`](../09-blocking/mapa-prontidao-mitm-piloto-2026-08-09.md)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.11 + D0/D1 + Gate C + GO teste + P3 + P4.1 | Alta | package/GUI | Identity+MITM | Piloto sem ficha/soak | M | Alto | **P3 PASS** `1.9.47`; **P4 FAIL/ABORT**; **P4.1 local** `1.9.59`; activar externo **NO-GO** até ficha+P5 | supervisor on-box; sem publish; sem piloto externo |
