...
- Passo actual: **20.14 / IM3** (persistência); **20.13 API PASS**; **IM1/GI1 PASS**; **IM2 DEFER 20.7a**
...
| BG-088 | Identity map **daemon** + LDAP/LDAPS (IM3–IM4) — **caminho de valor PME** | Critica | daemon/GUI | IM3–IM4 | user/grupo sem mapa dinâmico | G | Alto | Em curso / **passo 20.14** | API 20.13 PASS; persistência a seguir |
