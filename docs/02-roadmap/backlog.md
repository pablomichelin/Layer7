...
| BG-160 | Aplicar migração de defaults após upgrade | Alta | package/GUI | manutenção / F4.3 | idioma já selecionado após upgrade impede migração dos defaults PT | P | Baixo | **Implementado — pendente de gates/release** (`1.9.69`, `2026-08-15`) | Salvar Configurações aplica o idioma selecionado aos defaults reconhecidos, mesmo sem troca de idioma. Conteúdo personalizado, daemon, licença e `.244` intactos. |
