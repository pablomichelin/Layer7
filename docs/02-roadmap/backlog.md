...
- Passo actual: **20.10b PASS** (`1.9.40`); próximo **20.11**; Identity rede **FECHADA** (20.33/GI9)
...
| BG-087 | MITM TLS opt-in + CA (IM2) — 20.8–20.10b | Alta | package/GUI | Identity+MITM | GI2/GI3 20.11 | M | Alto | **20.10b PASS (`1.9.40`)** | listen/rdr/página gated; próximo 20.11 |
