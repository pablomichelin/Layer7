...
**campo BLOCKED** (license-server live sem 30.9). BG-117: falta deploy 30.9 live +
e2e + `30.11`. **Próximo:** decisão humana deploy license-server 30.9 — **não** `30.11`.
