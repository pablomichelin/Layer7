...
**P2-7+P2-8+P2-10 FEITOS** no git (`2026-08-14`; sem deploy / `PORTVERSION`). Próximo código com GO:
P2 restantes (exceto P2-9 sem GO; sem P2-7/8/10). **P0-1 ACTIVO** inalterado.
