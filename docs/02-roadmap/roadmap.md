...
**Trilha Identity + MITM Add-on:** [`plano-identity-mitm-addon.md`](plano-identity-mitm-addon.md) — **ABERTA** (Identity rede FECHADA; P4 retry2 CLOSED PASS; P5 aguarda ficha; lab/`latest` `1.9.62`).  
