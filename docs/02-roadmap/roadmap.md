...
**Trilha Identity + MITM Add-on:** [`plano-identity-mitm-addon.md`](plano-identity-mitm-addon.md) — **ABERTA** (IM1 / 20.6).
Arranque: [`../00-overview/START-HERE-identity-mitm.md`](../00-overview/START-HERE-identity-mitm.md).
ADRs Aceito (`2026-08-05`, T1): 0025 / 0026 / 0027 / 0028. Backlog BG-085…BG-092. GI0 PASS; 20.3–20.5 PASS.
