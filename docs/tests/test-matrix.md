...
| # | Teste | Onde | Status |
|---|-------|------|--------|
| 14.1 | Rotação por tamanho preserva `.1`–`.3` e nunca cria `.4` | local/builder | OK (`test_log_store.c`) |
...
| 15.2 | App normal resolve para `pdst`; quarentena explícita para `psrc` | local C / builder PHP | OK |
| 15.3 | Allow explícito impede nova inserção no callback; entrada PF prévia é FP-017 | local C | OK (`test_policy_decide.c`) |
...
| 15.6 | Build nDPI/PHP e validação do `.pkg` `_27` | FreeBSD 15 | OK (`SHA256=8eae978d8d3120f050be21d2fdf511aacbf03ba0ad2c9c350c15100818ed5388`) |
...
## 17. Candidato `1.8.11_29` — parser PF anti-QUIC
...
## 18. Candidato `1.8.11_30` — continuidade da tabela de fluxos
...
| 19.3 | Build nDPI comprova `NDPI_STATE_CLASSIFIED` e `ndpi_detection_giveup()` no binário `_31` | FreeBSD 15 | OK (`SHA256=dc5118dd01193a83a6c6d15cc3ae4ca300647294a5b188e1991a363b4c453e33`; pacote extraído PASS) |
