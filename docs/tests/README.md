...
Estado actual: 61 OK e 4 pendentes em appliance/lab para fechar a validacao
manual de grace/offline e da matriz real de fingerprint em reinstall, troca
de NIC, clone de VM, restore e migracao.
