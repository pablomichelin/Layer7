...
[`test-matrix.md`](test-matrix.md) — 74 testes divididos por categoria
...
Estado actual: 70 OK e 4 pendentes em appliance/lab para fechar a validacao
...
e migracao; a F3.4 acrescenta checks de guardrail administrativo e auditoria
minima no backend.
