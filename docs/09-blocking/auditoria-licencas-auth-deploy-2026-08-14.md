...
| Teste | Backend 258/258 PASS; frontend 59/59 PASS + build; regressão C de zone-id PASS; `git diff --check` PASS; builder FreeBSD: pubkey, port-files, smoke e `make package` PASS. Stage oficial `1.9.64` criado, assinado, verificado e publicado no canal `pablomichelin/Layer7` (7 assets); SHA256 `692ab615b0a45f70958f2b866d339e44f833f7953aeec5f780ee0af9e5afeb5f`. |
