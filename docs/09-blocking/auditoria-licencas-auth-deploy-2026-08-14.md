...
comprimento + `timingSafeEqual`. Residual P3-4. Sem deploy /
`PORTVERSION`.
**P0-1 permanece ACTIVO** — versionar ≠ publicar. Sem `.244` / rebuild /
GitHub Release / `PORTVERSION`. Próximo código com GO: P2 restantes
(exceto P2-9 sem GO; sem P2-7/8/10/11; sem M1/P2-17/P2-3; sem P1-9 runtime; sem P2-2; sem P2-13; sem P2-4; sem P3-1; sem P3-2; sem P3-3A; sem P3-3B; sem P3-3C).
...
24. **P2 / P3 restantes** — por severidade; P2-9 só com GO. Sem M1/P2-17/P2-3/P1-9 runtime; sem P2-2; sem P2-13; sem P2-4; sem P3-1; sem P3-2; sem P3-3A; sem P3-3B; sem P3-3C. Residual P3-4.
