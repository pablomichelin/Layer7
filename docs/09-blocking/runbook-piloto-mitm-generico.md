...
**P3 — código:** failsafe de janela + visibilidade operador + auditoria de metadados de activação (ver mapa §e).  
Sem P3 (ou equivalente ops dual aprovado), **não** abrir piloto multi-hora.
