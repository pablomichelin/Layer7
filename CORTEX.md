...
**BG-128** aberto; **P0-2 e P1-1 FEITOS** no git `2026-08-14` sem deploy); fecho
...
**P0-2 e P1-1 FEITOS** no git (`2026-08-14`; TOTP HMAC fail-closed; check-in
arquivada → 409 `revoked`/`expired`; sem deploy). Próximo código com GO = **P1-2**.
...
**BG-128** aberto (remediações P0–P3). **P0-2 e P1-1 FEITOS** no git
(`2026-08-14`; sem deploy). Próximo código com GO: **P1-2**. Worktree sujo
...
- **Auditoria `2026-08-14` / freeze deploy:** **BG-128 ABERTO** — P0-1 ACTIVO;
  **P0-2 e P1-1 FEITOS** no git (`2026-08-14`; sem deploy)
...
- Auditoria 2026-08-14: registada; P0-1 ACTIVO (proibido deploy integral HEAD); BG-128 ABERTO; P0-2 e P1-1 FEITOS no git; próximo código com GO = P1-2
