...
+ `PORTREVISION`):** `1.8.11_4` (`PORTVERSION=1.8.11`, `PORTREVISION=4`;
...
- PORTVERSION no repositorio (pre-release / proximo build): 1.8.11 (PORTREVISION 4)
...
- A referencia de **instalacao publica** continua a ser o pacote `1.8.3` ate
  nova release; o branch carrega `PORTVERSION=1.8.11` com `PORTREVISION=4` para
