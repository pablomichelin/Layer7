...
**BG-128** aberto; **P1-1 FEITO** no git `2026-08-14` sem deploy); fecho
...
**P1-1 FEITO** no git (`2026-08-14`; check-in arquivada → 409 `revoked`/`expired`;
sem deploy). Próximo código com GO = **P0-2**.
...
**BG-128** aberto (remediações P0–P3). **P1-1 FEITO** no git (`2026-08-14`;
sem deploy). Próximo código com GO: **P0-2**. Worktree sujo `30.11` **não**
commitado. **GA6.7** continua
...
- **Auditoria `2026-08-14` / freeze deploy:** **BG-128 ABERTO** — P0-1 ACTIVO;
  **P1-1 FEITO** no git (`2026-08-14`; sem deploy)
...
- Auditoria 2026-08-14: registada; P0-1 ACTIVO (proibido deploy integral HEAD); BG-128 ABERTO; P1-1 FEITO no git; próximo código com GO = P0-2
