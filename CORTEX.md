...
## Status atual
**Versão: 1.4.6 — Relatórios com domínio realmente tentado**
...
## Ultima entrega
- **v1.4.6 — Relatórios com domínio realmente tentado (2026-03-24):**
  ...
  - PORTVERSION incrementado para 1.4.6
...
## Objetivo imediato
**v1.4.6 — Relatórios com domínio realmente tentado.**
...
correlação DNS para mostrar domínio realmente tentado (v1.4.6).
...
## Proximos 3 passos
1. Build v1.4.6 no FreeBSD builder e publicar GitHub Release
2. Validar em campo se eventos `dns_query` aparecem para clientes LAN
3. Validar relatórios com correlação (IP/site tentado e exportação após 10+ minutos)
