...
`1.9.20` (GitHub Releases `pablomichelin/Layer7`, tag `v1.9.20`;
`SHA256=a41e7287c257c6842adbda4f81b1e2b411dbc912cc2da8433bbcc62fc1d8f254`;
GUI tabs contraste + Identity DC 20.20; comandos em
...
Rollback lab a partir de `1.9.20`: **`1.9.19`**. Historico: `_69`, `_24`.
...
**Candidato port:** `1.9.20` (GUI tabs contraste; **publicado** lab/`latest`).
...
- Candidato / latest: **1.9.20** (publicado)
...
- Canal publico latest: **1.9.20** (GUI tabs contraste + Identity DC 20.20)
...
- Pacote publicado: **1.9.20** (`SHA256=a41e7287c257c6842adbda4f81b1e2b411dbc912cc2da8433bbcc62fc1d8f254`)
- Hardening: **1.9.9**…**1.9.12** + guia RA **1.9.13**; Identity **1.9.14**…**1.9.20**
