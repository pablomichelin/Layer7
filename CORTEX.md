...
passo actual **20.26 / IM6** (lab GI7).
...
- Trilha Identity + MITM: **ABERTA** — passo **20.26** (20.25 PASS precedência; PME Identity-first; MITM DEFER 20.7a); arranque docs/00-overview/START-HERE-identity-mitm.md
...
- Proximo trabalho: Identity+MITM **20.26** GI7 lab; GI6 lab residual; MITM DEFER; GO promoção enforce; BG-028 fase 1
