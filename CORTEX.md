...
`1.8.11` (artefacto ainda nao publicado; actualizar manual e procedimentos na
...
- PORTVERSION no repositorio (pre-release / proximo build): 1.8.11
...
- A referencia de **instalacao publica** continua a ser o pacote `1.8.3` ate
  nova release; o branch pode carregar `PORTVERSION=1.8.11` para o proximo
  empacotamento.
