...
+ `PORTREVISION`):** `1.8.11_2` (`PORTVERSION=1.8.11`, `PORTREVISION=2`;
...
- PORTVERSION no repositorio (pre-release / proximo build): 1.8.11 (PORTREVISION 2)
...
- A referencia de **instalacao publica** continua a ser o pacote `1.8.3` ate
  nova release; o branch carrega `PORTVERSION=1.8.11` com `PORTREVISION=2` para
