...
Rollback lab a partir de `1.9.11`: **`1.9.10`**. Historico: `_69`, `_24`.
...
**Hardening:** `1.9.9`…`1.9.11` (BG-093…104); **não** misturar com Identity+MITM.
...
- Hardening: **1.9.9**…**1.9.11** publicados; não misturar com IM1
...
- Proximo trabalho: GO promoção enforce 1.9.11 **ou** Identity+MITM 20.2; BG-028 fase 1 quando chaves humanas
