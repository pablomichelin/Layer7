...
`1.9.22` (GitHub Releases `pablomichelin/Layer7`, tag `v1.9.22`;
`SHA256=79fb1ba64136b88781b123bfab8942b46f466f4185813d484c9bb08aa87e4fe2`;
MITM fora do menu + Identity DC 20.20; comandos em
...
Rollback lab a partir de `1.9.22`: **`1.9.21`**. Historico: `_69`, `_24`.
...
**Candidato port:** `1.9.22` (MITM fora do menu; **publicado** lab/`latest`).
...
- Candidato / latest: **1.9.22** (publicado)
...
- Canal publico latest: **1.9.22** (MITM fora do menu + Identity DC 20.20)
...
- Pacote publicado: **1.9.22** (`SHA256=79fb1ba64136b88781b123bfab8942b46f466f4185813d484c9bb08aa87e4fe2`)
- Hardening: **1.9.9**…**1.9.12** + guia RA **1.9.13**; Identity **1.9.14**…**1.9.22**
