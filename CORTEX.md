...
passo actual **20.32 / IM9** (MANUAL / notes comerciais Identity de rede).
...
- Passo actual: **20.32** (MANUAL / notes IM9)
...
- Trilha Identity + MITM: **ABERTA** — passo **20.32** (20.31 malha PASS; ADR-0029 fechou IM7/IM8; PME Identity-first; MITM DEFER 20.7a); arranque docs/00-overview/START-HERE-identity-mitm.md
...
- Proximo trabalho: Identity+MITM **20.32** MANUAL/notes; 20.33 GI9; GI5–GI7 lab residual AD; MITM DEFER; GO promoção enforce; BG-028 fase 1
