...
passo actual **20.25 / IM6** (precedência formal → core/precedence.md).
...
- Proximo trabalho: Identity+MITM **20.25** precedência; GI6 lab residual; MITM DEFER; GO promoção enforce; BG-028 fase 1
