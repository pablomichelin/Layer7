...
`1.9.21` (GitHub Releases `pablomichelin/Layer7`, tag `v1.9.21`;
`SHA256=763d60e4f1ac447818ea5fdbd595187aca5d4857e67d22e62e011a5c1a07d68c`;
menu UX + Identity DC 20.20; comandos em
...
Rollback lab a partir de `1.9.21`: **`1.9.20`**. Historico: `_69`, `_24`.
...
**Candidato port:** `1.9.21` (menu UX; **publicado** lab/`latest`).
...
- Candidato / latest: **1.9.21** (publicado)
...
- Canal publico latest: **1.9.21** (menu UX + Identity DC 20.20)
...
- Pacote publicado: **1.9.21** (`SHA256=763d60e4f1ac447818ea5fdbd595187aca5d4857e67d22e62e011a5c1a07d68c`)
- Hardening: **1.9.9**…**1.9.12** + guia RA **1.9.13**; Identity **1.9.14**…**1.9.21**
