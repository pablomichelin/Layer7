<?php
/**
 * Render baseline V6b2a + candidato com os mesmos stubs/dados (JSON stdin).
 * Saida: {"baseline":"...","candidate":"..."}
 */
require_once __DIR__ . "/bootstrap.php";

if (!function_exists("l7he_render_v6b2a_baseline") || !function_exists("l7he_render")) {
	fwrite(STDERR, "FAIL harness bootstrap: contrato V6b2a em falta\n");
	exit(1);
}
...
if (empty($base_opts["get"]["vip"]) && empty($base_opts["get"]["vip_add"]) &&
    ...
    empty($base_opts["post"]["add_vip_from_dhcp"])) {
...
if (!empty($base_opts["post"]["add_vip_from_dhcp"]) && empty($base_opts["get"]["vip"])) {
	$base_opts["get"]["vip"] = "1";
}
echo json_encode(array(
	"baseline" => l7he_render_v6b2a_baseline($base_opts),
