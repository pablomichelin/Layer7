	...
	<div class="panel-body">
		...
		<div class="layer7-content">
			...
			<div class="alert alert-warning"><?= l7_t("Limites da Lista VIP atingidos."); ?></div>
				...
				$sec_submit = new Form_Section("");
				$sec_submit->addInput(new Form_StaticText("", $dhcp_submit));
				$dhcp_form->add($sec_submit);
				print($dhcp_form);
			} ?>
			<?php } ?>
...
function l7setVisibleDhcpChecks(checked) {
	...
	for (i = 0; i < panels.length; i++) {
		if (panels[i].classList.contains("is-hidden") || panels[i].classList.contains("hidden")) {
			continue;
		}
...
function l7filterDhcpIface(ifid) {
	...
	for (i = 0; i < panels.length; i++) {
		...
		panels[i].classList.remove("is-hidden", "hidden");
		if (!match) {
			panels[i].classList.add("is-hidden", "hidden");
		}
	}
