...
| **Trilha activa** | **IPv6** — passo **12.5** (Onda V2); arranque único [`START-HERE-fecho-producao.md`](docs/00-overview/START-HERE-fecho-producao.md) |
...
**Arranque único (fecho FECHADO + trilha IPv6 activa, passo 12.5):**
...
**Trilha activa:** IPv6 (passo **12.5**, Onda V2 — nDPI/métricas) —
[`START-HERE-fecho-producao.md`](docs/00-overview/START-HERE-fecho-producao.md)
(arranque único; captura 12.4 PASS; próximo `.pkg` = `1.9.1`).

1. **Chat limpo:** colar só o caminho do START-HERE-fecho-producao.md.
2. Executar passo **12.5**; ver `CORTEX.md` secção Trilha IPv6.
