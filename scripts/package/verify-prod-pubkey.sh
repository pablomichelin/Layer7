...
# Fixture isolada: com L7_PROD_PUBKEY_HEX_FILE nunca se lê o SoT do builder.
# Sem a env, o path default existe para o make package no builder — a
# mensagem de erro não imprime esse path.
if [ ! -f "$HEX_FILE" ]; then
	echo "FAIL: SoT hex em falta" >&2
